        ...
        <div className="space-y-10" id="category-today-slots">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {todayPlans.map((plan, index) => {
              ...
              return (
                <div key={plan.id} className="bg-[#0b1222]/40 p-8 rounded-3xl border border-white/5 flex flex-col justify-between transition-all hover:bg-[#0b1222]/60 relative overflow-hidden group cursor-pointer shadow-xl">
                    ...
                    <button
                      ...
                      className={`w-full py-3.5 px-6 bg-${colorClass}-500 hover:bg-${colorClass}-400 text-${isBullish ? 'slate-950' : 'white'} font-bold text-xs rounded-xl transition-all uppercase tracking-widest flex items-center justify-center shadow-lg shadow-${colorClass}-500/20 mt-10`}
                    >
                      Invest Now
                    </button>
                  </div>
            ...
            {smallPlans.map((plan, index) => {
              ...
              return (
                <div key={plan.id} className="bg-[#0b1222]/40 p-8 rounded-3xl border border-white/5 flex flex-col justify-between transition-all hover:bg-[#0b1222]/60 relative overflow-hidden group cursor-pointer shadow-xl">
                    ...
                    <button
                      onClick={() => onInvestSelect(plan)}
                      className="w-full py-3.5 px-6 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs rounded-xl transition-all uppercase tracking-widest flex items-center justify-center shadow-lg shadow-amber-500/20 mt-10"
                    >
                      Invest Now
                    </button>
                  </div>
